...
public class KnowledgeBrowseController {
    ...
    @Operation(summary = "列出知识文档 / 索引 / 清单文件")
    @GetMapping
    public ApiResponse<List<KnowledgeBrowseItem>> list(@ModelAttribute KnowledgeBrowseQuery query) {
        return ApiResponse.success(knowledgeBrowseService.list(query));
    }
