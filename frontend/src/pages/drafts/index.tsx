...
const Drafts: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // v0.4 起复核页只展示需要复核的任务（PENDING_REVIEW / REVIEWING / CONFIRMED），
    // 历史任务（PUSHED / ARCHIVED / FAILED / CANCELLED）不进入本下拉，由 /push 等其他页承载。
